...
//var creatorList = ['Creator 𝓢𝓲𝓮𝓼𝓽 𝓫𝓸𝓽☘️', '𝓢𝓲𝓮𝓼𝓽 𝓫𝓸𝓽☘️ Indonesia', 'Creator Bot' , ' Bot WhatsApp']
...
zeksApikey = 'purokta' //ganti pake apikey lu biar limitnya gk cepet abis 
ApiZeks = 'apOZe09vdtq7f4rtOjAtPdNvuzI' // regis disini klo mau dapat apikeynya
...
img = setting.img
baper = '𝓜𝓪𝓼 𝓟𝓾𝓻😈'
apiku = 'https://youtu.be/2xx_2XNxxfA'
gc_wa_lu = 'https://chat.whatsapp.com/GJs45OMokDgCj5O4cpJpf4' //klo gk punya gc wa gk usah di ganti 👍
...
await alpha.updatePresence(from, Presence.composing)
	...
	return admins
		...
		const ratee = ["rate","rate","rate","rate","rate","rate","rate"]
...
let papakpo = [{
								...
								sendButLocation(from, userProcfile , `𝚂𝚒𝚎𝚜𝚝 𝚋𝚘𝚝 𝙱𝚢 𝙿𝚞𝚛𝚠𝚊𝚍𝚒}`,pp_userz, papao, {})
}
break
...
let papako = [{
								...
								sendButLocation(from, teks , `Thank for verification\n𝚂𝚒𝚎𝚜𝚝 𝚋𝚘𝚝 𝙱𝚢 @${koko.split('@')[0]}`,pp_userz, papako, {contextInfo: { mentionedJid: [sender]}})
                break
	case 'menu': case 'help':
			try {
...
ini_anu =`𝚂𝚒𝚎𝚜𝚝 𝚋𝚘𝚝 𝙱𝚢 @${koko.split('@')[0]}

			『 *𝓢𝓲𝓮𝓼𝓽 𝓫𝓸𝓽☘️*  』

*☘️ Creator :  @${koko.split('@')[0]}*
*☘️ Powered  : @${ini_mark.split('@')[0]}*
*☘️ Mode : ${status}*
*☘️ Status : ${offline ? 'OFFLINE' : 'ONLINE'}*
*☘️ Prefix : [  ${prefix}  ]*
*☘️ Group Chat : ${giid.length}*
*☘️ Private Chat : ${totalchat.length - giid.length}*
*☘️ Total Chat : ${totalchat.length}*
*☘️ Lib  : Baileys*
*☘️ Type  : NodeJs*
*☘️ Total hit : ${hitall}*
*☘️ Hit today : ${hit_today.length}*
*☘️ Speed : ${latensii.toFixed(4)} Second*
*☘️ Runtime : ${kyun(anunya)}*
*☘️ Battery : ${isBattre}*
*☘️ Charging : ${isCharge}*
...
`
if(menusimple == false){
sendButDoc(from, ini_anu, `ᵍⁱᵛᵉ ⁵ ˢᵉᶜᵒⁿᵈˢ ᵇᵉᶠᵒʳᵉ ᵗʰᵉ ⁿᵉˣᵗ ᶜᵒᵐᵐᵃⁿᵈ.\n@${koko.split('@')[0]}🪐`, sender, koko, ini_mark)
...
break
                ...
                let papao = [{
								...
								sendButLocation(from, allmenu(prefix, wita, wit, ucapannya2 , timuu, status, wa_version, mcc, mnc, os_version, device_manufacturer, device_model, alfa , alfa1, thisDay, ini_tanggal, totalchat, hit_today, ini_gcchat), `𝚂𝚒𝚎𝚜𝚝 𝚋𝚘𝚝 𝙱𝚢 𝙿𝚞𝚛𝚠𝚊𝚍𝚒🪐`,pp_userz, papao, {})
                break
        case 'trigger':
		   			...
		   			var mulaikah = aramat[0].url							
		                  try {
		                    ...
		                    .then((res) => {
		                        ...
		                        const captions = `🎧 *PLAY MUSIC*\n\n*Title* : ${title}\n*Ext* : MP3\n*Size* : ${filesizeF}\n*Link* : ${a.data}\n\n_Silahkan tunggu file media sedang dikirim mungkin butuh beberapa menit_\n*jika audio tidak muncul klik link biru di atas*`
...
let papako = [{
								...
								sendButLocation(from, teks , `Thank for verification\n𝚂𝚒𝚎𝚜𝚝 𝚋𝚘𝚝 𝙱𝚢 𝙿𝚞𝚛𝚠𝚊𝚍𝚒😈`,pp_userz, papako, {contextInfo: { mentionedJid: [sender]}})
                }
